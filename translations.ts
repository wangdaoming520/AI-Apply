...
export const translations = {
  en: {
    ...
    panel: {
      ...
      characterLabel: "Character Focus / Consistency",
      characterPlaceholder: "Key character details, expressions, clothing...",
  ...
  zh: {
    ...
    panel: {
      ...
      characterLabel: "角色焦点 / 一致性",
      characterPlaceholder: "关键角色细节、表情、服装...",
      regenerate: "重新生成",
      generate: "生成画面",
      drawing: "正在绘制...",
      noImage: "尚未生成图片",
